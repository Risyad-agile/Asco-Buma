...
<div class="row justify-content-center">
    ...
    <div class="card">
        <div id="toolbar"></div>
        <div class="card-body">
            <form method="POST" action="{{route('office.reports.purchase.supplier.product.main')}}">
                @csrf 
...
$(function(){
    ...
    items: [{
        ...
        locateInMenu: 'never',
        template: function() {
            return $("<div class='long-title'><h3>Pilih Lokasi Laporan</h3></div>");
        }
        },{
            location: 'after',
            widget: 'dxButton',
    ...
    var listDataSource = new DevExpress.data.DataSource({
        ...
        load: function (key) {
          return $.ajax({
            url: "{{route('stores.current.company')}}"
          })
      },
    });
