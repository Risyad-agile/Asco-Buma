...
<div class="row justify-content-center">
    <div class="col-md-8" style="margin-top: 25px;">
        <div class="card">
            <div id="toolbar"></div>
            <div class="card-body">
                <form method="POST" action="{{route('storereports.mutation.main')}}">
                    @csrf 
...
$(function(){
    ...
    items: [{
        ...
        locateInMenu: 'never',
        template: function() {
            return $("<div class='long-title'><h3>Pilih Lokasi Daftar Stok Mutasi</h3></div>");
        }
        },{
            location: 'after',
            widget: 'dxButton',
    ...
    var listDataSource = new DevExpress.data.DataSource({
        ...
        load: function (key) {
          return $.ajax({
                url: "{{URL::to('stores/name/byuser')}}"+"/"+userid,
          })
      },
    });
