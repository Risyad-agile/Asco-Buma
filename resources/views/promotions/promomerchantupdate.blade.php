          ...
          <div class="col-sm-6">
            <div class="panel panel-info">
              <div class="panel-body">
                ...
                <div class="form-group row">
                  <label for="numProdQty" class="col-sm-4 control-label text-md-right">Jumlah</label>
                  <div class="col-sm-8">
...
$(function() {
  ...
  $("#toolbar").dxToolbar({
    items: [{
        ...
        locateInMenu: 'never',
        template: function() {
            return $("<div class='long-title'><h3>Pembaharuan Promo Merchandise</h3></div>");
        }
        },{
            location: 'after',
            widget: 'dxButton',
  ...
  var dataGrid =$("#dataGrid").dxDataGrid({
      ...
      onRowRemoving: function(e) {
            if(e.data.promotionproducts.promo_product_state=="1"){
                DevExpress.ui.notify({
                  message: "Produk Utama tidak bisa di Hapus...",
                  position: {
                      my: "center top",
                      at: "center top"
                  }
  ...
  $("#btnSave").dxButton({
      ...
      onClick: function(e) {
          ...
          $.ajax({
              type: "POST",
              url: "{{route('promotions.merchant.update')}}",
              ...
              success: function (data) {
                if(data.code != 200) {
                    ...
                    .then((value) => {
                          window.location.href = '{{route('promotions.merchant.index')}}';
                    });
                }
                return false;
              },               
...
<script type="text/javascript">
  ...
  $("#btnAdd").off('click').click(function(clickEvent){
    ...
    if(!prodqty || prodqty==='0'){
      document.getElementById("wrmsg").innerHTML = 'WARNING : Jumlah tidak boleh 0 atau kosong';
      clickEvent.stopPropagation();
      return;
    }

    var table=$('#dataGrid').dxDataGrid("instance");
    var objpromoprod={promo_product_qty:prodqty,promo_product_state:2}
