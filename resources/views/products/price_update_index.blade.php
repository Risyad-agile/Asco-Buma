...
<div class="row justify-content-center">
    <div class="col-md-8" style="margin-top: 25px;">
        <div class="card">
            <div id="toolbar"></div>
            <div class="card-body">
                <form method="POST" action="{{route('products.price.main')}}">
                    @csrf 
                    <label>Pilih Toko</label>
                    <div id="simpleList"></div>
                    <div id="btnLanjut"></div>
                    <!-- <div id="selectedStores"></div> -->
                    <input id="txtstores" type="text" name="storeid"
...
$(function(){
    ...
    items: [{
        ...
        locateInMenu: 'never',
        template: function() {
            return $("<div class='long-title'><h3>Perbaharuan Harga Jual Produk</h3></div>");
        }
        },{
            location: 'after',
            widget: 'dxButton',
