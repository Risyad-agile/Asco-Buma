        ...
        <div class="col-md-8" style="margin-top: 25px;">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="form-container" class="first-group" method="POST" action="{{route('partner.task.maker.file.process')}}">
                        @csrf
...
$(function(){
    ...
    $("#toolbar").dxToolbar({
        items: [{
            ...
            options: {
                ...
                onClick: function(e) {   
                    window.location = "{{route('create.task.list')}}";   
                }
            }
        }]
    });
    var fileUploader = $("#file-uploader").dxFileUploader({
        ...
        uploadUrl:  "{{route('partner.task.maker.file.process')}}",
        maxFileSize: 250000, 
        onUploaded(e){
            console.log(e);
