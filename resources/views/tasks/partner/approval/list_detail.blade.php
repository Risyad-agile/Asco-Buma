...
$(function(){
        ...
        items: [{
            ...
            template: function() {
                    ...
                    onClick: function(e) {    
                        ...
                        if(state!="3") { //Checked
                            Swal.fire({
                              ...
                              text: "Task State must Checked before approving...",
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                $.ajax({
                                    type: "PUT",
                                    url: "{{URL::to('partner-manager/task/approval/submit')}}"+"/"+taskid,
                ...
                options: {
                    ...
                    hint: 'Close', 
                    onClick: function(e) {      
                        window.location = "{{route('partner.task.approval.list.task')}}";
                    }
                }
            }]
        });
  ...
  function rejecttask(taskid,reject_reason) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "{{route('partner.task.approval.reject')}}",
                method: "POST",
                ...
                success: function (data) {
                    if(data.code != 200) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '{{route('partner.task.approval.list.task')}}';
                        });
                    }
                    return false;
                },    
