...
<script type="text/javascript">
    ...
    var gridDataSource = new DevExpress.data.DataSource({
        store: new DevExpress.data.CustomStore({
            key: "id",
            load: function () {
                return $.getJSON("{{ URL::to('partner-user/create/task/crud/readS') }}/"+ taskid+"/"+transno);
            },
            insert: function (values) {
                ...
                return $.ajax({
                    url: "{{ route('create.task.crud.insertRowCSR') }}",
                    type: "POST",
            ...
            update: function (key, values) {
                return $.ajax({
                    url: "{{ url('partner-user/create/task/crud/updateCSR') }}/" + key,
                    type: "PUT",
                    contentType: "application/json",
            ...
            remove: function (key) {
                return $.ajax({
                    url: "{{ url('partner-user/create/task/crud/updateDelCSR') }}/" + key,
                    type: "DELETE",
                    contentType: "application/json",
                    success: function () {
