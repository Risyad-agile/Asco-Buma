...
<script type="text/javascript">
    ...
    var gridDataSource = new DevExpress.data.DataSource({
        store: new DevExpress.data.CustomStore({
            key: "id",
            load: function () {
                return $.getJSON("{{ URL::to('partner-user/create/task/crud/readE') }}/"+ taskid+"/"+transno);
            },
            insert: function (values) {
                ...
                return $.ajax({
                    url: "{{ route('create.task.crud.insertRow') }}",
                    type: "POST",
            ...
            update: function (key, values) {
                return $.ajax({
                    url: "{{ url('partner-user/create/task/crud/update') }}/" + key,
                    type: "PUT",
                    contentType: "application/json",
            ...
            remove: function (key) {
                return $.ajax({
                    url: "{{ url('partner-user/create/task/crud/updateDel') }}/" + key,
                    type: "DELETE",
                    contentType: "application/json",
                    success: function () {
