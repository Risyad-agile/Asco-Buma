...
<form method="POST" action="{{route('partner.job.main')}}">
    @csrf
    <div id="toolbar"></div>
    <div id="gridContainer"></div> 
    <!--
    <input id="txtcompid" type="text" name="compid" value="{!!$company->id!!}" class="form-control" >
    <input id="txtid" type="text" name="id" class="form-control" >
    <input id="txtstate" type="text" name="state" class="form-control"  >
    -->
</form>
...
function jobExecute(loadPanel,jobid) {
    Swal.fire({
        title: 'Confirmation',
