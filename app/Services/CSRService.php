        ...
        try {
            ...
            foreach ($contents as $content) {
                ...
                $summaryPayload = [
                    ...
                    'pillar_socio_culture_plan'    => $pillars['Socio-Cultural & Religious']['pillarPlan'] ?? 0,
                    'pillar_infra_env_plan'        => $pillars['Infrastucture & Environmental Development']['pillarPlan'] ?? 0,
                    'pillar_education_health_plan' => $pillars['Education & Health']['pillarPlan'] ?? 0,
                    'pillar_economic_dev_plan'     => $pillars['Economic Development']['pillarPlan'] ?? 0,
